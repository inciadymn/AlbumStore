...
namespace AlbumStore.UI.MVC.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        {
            if (ModelState.IsValid) //bir kontroler nesnesidir ve Isvalid propertysi validasyona yazdıkalarımı doğru karşılıyorsam true gelir. Herhangi bir validasyon doğru karşılanmazsa false gelir
            {
